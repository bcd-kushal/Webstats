...
export const SITES_LIST = [
    ...
    { name: "Ed.Line", subtitle:"edline.kushalkumarsaha.com", targetClassIndex:"traffic-edline" },
    { name: "Minify", subtitle:"minify.kushalkumarsaha.com", targetClassIndex:"traffic-minify" },
    { name: "API-Fetch", subtitle:"apifetch.kushalkumarsaha.com", targetClassIndex:"traffic-apifetch" },
    { name: "Fireworks", subtitle:"fireworks.kushalkumarsaha.com", targetClassIndex:"traffic-fireworks" }, */
]