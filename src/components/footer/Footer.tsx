...
export async function Footer() {
    return (
        <footer className="">
    <section className={`mt-9 flex flex-col md:flex-row gap-1 md:gap-2 md:items-center justify-center items-start md:justify-between px-4 md:px-8 py-3 md:mb-7 text-lg ${maxContentSpace}`}>
